...
export default function AddDistrictPartner() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            navigate('/dashboard/admin/district-partner', { replace: true });
        } catch (submitError) {
            setError(submitError?.response?.data?.message || 'Failed to add district partner.');
        } finally {
            setSaving(false);
        }
    };
    ...
    return (
        <div className="p-4 sm:p-5">
            <div className="mb-4 flex items-center justify-between gap-3">
                <h1 className="text-lg font-bold uppercase tracking-wide text-blue-600">Add District Partner</h1>
                <button
                    type="button"
                    onClick={() => navigate('/dashboard/admin/district-partner')}
            ...
            <form onSubmit={handleSubmit} className="space-y-5 rounded-lg border border-gray-200 bg-[#f7f7f8] p-4 dark:border-gray-700 dark:bg-[#303030]">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div className="space-y-1">
                        ...
                        <select value={form.district} onChange={(e) => handleChange('district', e.target.value)} className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm dark:border-gray-600 dark:bg-[#3b3b3b]">
                ...
                <div>
                    ...
                    <div className="mt-2 grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <label className="inline-flex items-center gap-2 text-sm font-medium text-blue-600 md:col-span-2">
                ...
                <div>
                    ...
                    <label htmlFor="add-district-partner-documents" className="mt-2 flex h-14 cursor-pointer items-center justify-center rounded-md border border-dashed border-gray-300 bg-white px-4 text-sm text-green-700 dark:border-gray-600 dark:bg-[#2e2e2e]">
                        Drop files here or click to upload.
                    </label>
                    <input id="add-district-partner-documents" type="file" multiple className="hidden" onChange={(e) => handleChange('documents', Array.from(e.target.files || []))} />
